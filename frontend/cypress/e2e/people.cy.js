...
const EDIT_SUBMIT_BUTTON_PATH = 'html > body > div:nth-of-type(2) > div > div:nth-of-type(3) > div > div:nth-of-type(2) > div > div:nth-of-type(2) > div > div > div > div:nth-of-type(3) > div > div > form > div:nth-of-type(2) > div > div > div > div > button > span';
...
describe('ST-004', () => {
    ...
    it('ST4-CT001', () => {
        ...
        cy.get(EDIT_SUBMIT_BUTTON_PATH).click();
    });
