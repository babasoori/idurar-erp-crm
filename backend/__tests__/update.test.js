...
describe('update function ', () => {
    ...
    it('should update an email by id', async () => {
        const email = await Email.findOne({emailName: "Email Three"}).exec()
        mockedReq.params.id = email._id
        mockedReq.params.body = 'hello world'
        await update(Email, mockedReq, mockedRes)
    ...
    it('should handle error in id input', async () => {
        ...
        await expect(update(Email, mockedReq, mockedRes)).rejects.toThrow("Invalid _id value: { _id: hello }");
    });
